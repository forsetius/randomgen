...
import { WhiteDwarfStellarClass } from '../StellarClassInterface';

export class DType implements StellarClassBuilder {
  public rollSpectralSubtype(): string {
  ...
  public ageStar(by: number): WhiteDwarfStellarClass {
